# Generated by Django 2.0.5 on 2018-06-22 17:18
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('djstripe_created', models.DateTimeField(auto_now_add=True)),
                ('djstripe_updated', models.DateTimeField(auto_now=True)),
                ('quantity', djstripe.fields.StripeIntegerField(help_text='The quantity of the plan to which the customer should be subscribed.', null=True)),
                ('plan', models.ForeignKey(help_text='Hash describing the plan the customer is subscribed to.', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='subscriptionitems', to='djstripe.Plan')),
                ('subscription', models.ForeignKey(help_text='The subscription this subscription_item belongs to.', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='subscriptionitems', to='djstripe.Subscription')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(help_text='The subscription item that this invoice item has been created for, if any.', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='invoiceitems', to='djstripe.SubscriptionItem'),
        ),
        migrations.AddField(
            model_name='invoice',
            name='charge',
